...
export default function SignIn() {
  ...
  // const giaTriTraVeCuaUseState = useState({}); // trả về mảng vị trí 0 là state, vị trí 1 là set lại state
  // // console.log(giaTriTraVeCuaUseState);
  ...
  function handleSubmit(event) {
    event.preventDefault(); //chan su kien load trang
